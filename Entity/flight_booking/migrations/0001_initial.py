# Generated by Django 2.1.3 on 2018-11-16 06:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('paid', 'paid'), ('canceled', 'canceled')], max_length=128, verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            name='Flight',
            fields=[
                ...
                ('capacity', models.PositiveIntegerField(verbose_name='Available Seats')),
